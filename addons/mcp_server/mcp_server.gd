...
## Registry instance for managing MCP tools
var tool_registry = preload("res://addons/mcp_server/core/mcp_tool_registry.gd").new()

## Aliases to maintain compatibility with external access
